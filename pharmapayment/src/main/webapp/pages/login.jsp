...
<body>
                    ...
                    <f:form>
                        <div class="col">
                            ...
                            <div class="row"
                               ...
                               <div class="col">
                                <a href="#" class="btn btn-outline-dark btn-lg">Login</a>
                            </div>
    ...
    <!--button type='button' class="btn btn-outline-dark btn-lg" style="text-align: center;font-size: 14px;"
        data-toggle="modal" data-target="#popUpWindow">Open Log In
        Window</button-->
